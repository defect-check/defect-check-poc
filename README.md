# defect-check-poc
Proof of concept of the defect detection project. Code written here will be used for defect-check application and defect-check-client. This branch tracks changes from this repository [Mask-RCNN-TF2](https://github.com/ahmedfgad/Mask-RCNN-TF2) for merging into main.
